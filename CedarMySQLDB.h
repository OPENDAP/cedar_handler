...
#ifndef CedarMySQLDB_h_
#define CedarMySQLDB_h_ 1
...
class CedarMySQLDB : public CedarDB
{
private:
    CedarMySQLConnect *		_connection ;
    string			_mysql_server ;
    string			_mysql_user ;
    string			_mysql_pwd ;
    string			_mysql_db ;
    int				_mysql_port ;
    string			_mysql_socket ;
    				CedarMySQLDB( CedarMySQLDB &db ) {}
public:
